...
<head>
    ...
    <style>
        ...
        .product-card { background: white; border-radius: 10px; padding: 15px; margin: 10px; 
                        display: inline-block; width: 220px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); border-top: 5px solid #1e90ff; }
        .price { color: #2e8b57; font-weight: bold; font-size: 1.4em; margin: 10px 0; }
        .btn { background: #1e90ff; color: white; border: none; padding: 10px 15px; border-radius: 5px; cursor: pointer; transition: 0.3s; }
...
if __name__ == '__main__':
    # Using 0.0.0.0 is critical for Docker/Kubernetes access
